...
class StrategyApprovalMapperContractTest {
    ...
    void nullableApprovalWritesUseExplicitOracleJdbcTypes() throws Exception {
        ...
        assertThat(sql)
                ...
                .contains("#{avoidedDisposalCost,jdbcType=NUMERIC}")
                .contains("#{avoidedHoldingCost,jdbcType=NUMERIC}")
                .contains("#{netEffect,jdbcType=NUMERIC}")
                ...
                .contains("#{transferRouteId,jdbcType=NUMERIC}")
                .contains("#{transferCostPolicyId,jdbcType=NUMERIC}")
                .contains("#{movementCostStatus,jdbcType=VARCHAR}")
                .contains("#{movementWeightKg,jdbcType=NUMERIC}")
                .contains("#{movementDistanceKm,jdbcType=NUMERIC}")
                .contains("#{movementCostPerKgKm,jdbcType=NUMERIC}")
